...
define([], function () {
  ...
  */
   ...
   */
		initialize: function initialize(dialog, showButton, closeButton) {
   ...
   */
		registerDialogPolyfill: function registerDialogPolyfill(dialog) {
			if (!window.HTMLDialogElement) {
				require(['mustard/dialog-polyfill', 'css!mustard/dialog-polyfill.css'], function (dialogPolyfill) {
   ...
   */
		setupShowDialogButton: function setupShowDialogButton(dialog, buttons) {
			if (!buttons) {
   ...
   * @param dialog node - the dialog node to reference
   */
		setupCloseDialogButton: function setupCloseDialogButton(dialog, buttons) {
			if (!buttons) {
   ...
   * @param dialog node
   */
		setupBackdropClose: function setupBackdropClose(dialog) {
